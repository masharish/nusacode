...
<html lang="en-us"><head>
  <meta charset="utf-8">
  <title>masharish | Personal Blog Template</title>
  ...
  <!-- plugins -->
  <link rel="stylesheet" href="{{asset ('template1/plugins/bootstrap/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{asset ('template1/plugins/themify-icons/themify-icons.css') }}">
  <link rel="stylesheet" href="{{asset ('template1/plugins/slick/slick.css') }}">

  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{{asset ('template1/css/style.css') }}" media="screen">

  <!--Favicon-->
  <link rel="shortcut icon" href="{{asset ('template1/images/favicon.png') }}" type="image/x-icon">
  <link rel="icon" href="{{asset ('template1/images/favicon.png') }}" type="image/x-icon">
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-white">
      <a class="navbar-brand order-1" href="index.html">
        <img class="img-fluid" width="100px" src="{{asset ('template1/images/logo.png') }}"
      ...
      <div class="collapse navbar-collapse text-center order-lg-2 order-3" id="navigation">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link text-danger" href="/dashboard">Login</a>
          </li>
        </ul>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 mx-auto">
        <h1 class="mb-5">Selamat Datang <br> di Blog Pribadi Mase</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 mb-5">
        ...
        <article class="card">
          <div class="post-slider slider-sm">
            <img src="{{asset ('template1/images/post/post-1.jpg') }}" class="card-img-top" alt="post-thumb">
          </div>
            ...
            <ul class="card-meta list-inline">
              <li class="list-inline-item">
                <a href="author-single.html" class="card-meta-author">
                  <img src="{{asset ('template1/images/john-doe.jpg') }}">
      ...
      <div class="col-lg-4 mb-5">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            <img class="card-img-sm" src="{{asset ('template1/images/post/post-3.jpg') }}">
            <div class="ml-3">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            <img class="card-img-sm" src="{{asset ('template1/images/post/post-2.jpg') }}">
            <div class="ml-3">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            <img class="card-img-sm" src="{{asset ('template1/images/post/post-4.jp') }}g">
            <div class="ml-3">
      ...
      <div class="col-lg-4 mb-5">
        ...
        <article class="card">
          <div class="post-slider slider-sm">
            <img src="{{ asset('template1/images/post/post-5.jpg') }}" class="card-img-top" alt="post-thumb">
          </div>
          <div class="card-body">
            ...
            <ul class="card-meta list-inline">
              <li class="list-inline-item">
                <a href="author-single.html" class="card-meta-author">
                  <img src="{{ asset('template1/images/kate-stone.jpg') }}" alt="Kate Stone">
...
<section class="section-sm">
  ...
  <div class="post-slider">
      <img src="{{asset ('template1/images/post/post-10.jpg') }}" class="card-img-top" alt="post-thumb">
      <img src="{{asset ('template1/images/post/post-1.jpg') }}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      ...
      <li class="list-inline-item">
          <a href="author-single.html" class="card-meta-author">
          <img src="{{asset ('template1/images/john-doe.jpg') }}" alt="John Doe">
          <span>John Doe</span>
          </a>
      </li>
      <li class="list-inline-item">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset ('template1/images/post/post-3.jpg') }}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset ('template1/images/post/post-7.jpg') }}" class="card-img-top" alt="post-thumb">
  </div>
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset ('template1/images/post/post-8.jpg') }}" class="card-img-top" alt="post-thumb">
      <img src="{{asset ('template1/images/post/post-9.jpg') }}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and Cashmere Recipe At Home</a></h3>
      <ul class="card-meta list-inline">
  ...
  <div class="widget widget-about">
    ...
    <img class="img-fluid" src="{{asset ('template1/images/author.jpg') }}" alt="Themefisher">
  ...
  <!-- Promotion -->
  <div class="promotion">
    <img src="{{ asset('template1/images/promotion.jpg') }}" class="img-fluid w-100">
  ...
  <div class="widget widget-author">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset ('template1/images/john-doe.jpg') }}">
      </div>
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset ('template1/images/kate-stone.jpg') }}">
      </div>
      <div class="media-body">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset ('template1/images/john-doe.jpg') }}" alt="John Doe">
      </div>
      <div class="media-body">
  ...
  <div class="widget">
    ...
    <article class="widget-card">
      <div class="d-flex">
        <img class="card-img-sm" src="{{asset ('template1/images/post/post-10.jpg') }}">
        <div class="ml-3">
...
<footer class="footer">
  ...
  <div class="container">
      ...
      <div class="col-md-2 text-center mb-4">
          <a href="index.html"><img class="img-fluid" width="100px" src="{{asset ('template1/images/logo.png') }}" alt="Reader | Hugo Personal Blog Template"></a>
      </div>
  ...
  <script src="{{asset ('template1/plugins/bootstrap/bootstrap.min.js') }}"></script>

  <script src="{{asset ('template1/plugins/slick/slick.min.js') }}"></script>

  <script src="{{asset ('template1/plugins/instafeed/instafeed.min.js') }}"></script>


  <!-- Main Script -->
  <script src="{{asset ('template1/js/script.js') }}"></script></body>
</html>
